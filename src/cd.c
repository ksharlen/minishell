...
//!VAlIDACIYA IZ GOVNA YA HZ KAK UZNAT' POLNIY PUT', DA YA TUPOY
//!оно причем когда как, когда работает, когда нет, соре(((((

// static int	valid(char *argv[], char **full_path, char *home_dir)
// {
// 	int		i;
// 	int		check;
// 	char	*check_path;
